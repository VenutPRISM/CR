//
// Znacheniya, ispol'zuyemyye mashinoy steka
//
#ifndef VALUE_H
#define VALUE_H
...
public:
    int value_type;
    int int_value; // Dlya massiva, eto smeshcheniye elementa massiva
    double double_value;
    string string_value;
    NameDef* name_ptr;
    ...
    void print() const;
    void scanf() throw (InterpretatorException);
};
